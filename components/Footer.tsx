      ...
      <div className="container mx-auto px-6 py-8">
        <div className="flex flex-wrap justify-between items-center">
          <div className="w-full md:w-1/3 text-center md:text-left">
            <h3 className="text-2xl font-semibold text-blue-600">MindWell</h3>
            <p className="mt-2 text-sm text-gray-600">Your Companion for Mental Wellness</p>
          </div>
          ...
          <div className="w-full md:w-1/3 mt-6 md:mt-0 text-center md:text-right">
            <h4 className="text-lg font-semibold text-gray-700 mb-2">Connect With Us</h4>
